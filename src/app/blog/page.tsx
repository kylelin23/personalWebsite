...
const POSTS = [
  { href: '/blog/midAutumnFestival.html', title: 'Mid Autumn Festival', date: 'Sep 2024' },
  { href: '/blog/firstWeekOfSchool.html', title: 'First Week of School', date: 'Sep 2024' },
];
            ...
            >
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:16}}>
                <div>
                  ...
                  {post.date && (
                    <p style={{fontSize:11,color:'rgba(200,160,80,0.45)',letterSpacing:2,textTransform:'uppercase',margin:0}}>
                      {post.date}
                    </p>
                  )}
                </div>
