...
"[project]/personalWebsite/src/app/api/blog/[slug]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    try {
        const blog = await __TURBOPACK__imported__module__$5b$project$5d2f$personalWebsite$2f$src$2f$database$2f$blogSchema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            slug
        }).orFail();
        console.log("API blog:", JSON.stringify(blog, null, 2));
        return __TURBOPACK__imported__module__$5b$project$5d2f$personalWebsite$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(blog);
    } catch (err) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$personalWebsite$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json('Blog not found.', {
            status: 404
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df979122._.js.map